...
What if the busiest transport route is not the most efficient one?  That was one of the questions I explored in this exploratory data analysis project: Optimizing Public Transit Operations for MetroMove Transit Solutions.
